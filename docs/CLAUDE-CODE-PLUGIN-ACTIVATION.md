...
description: "Why ap init --with-plugin hooks didn't fire and the 0.1.5 fix (.claude/settings.json), plus the 26-event registry, failure modes, and troubleshooting."
---
