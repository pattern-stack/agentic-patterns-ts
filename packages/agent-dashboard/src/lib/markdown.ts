...
function mdEmphasis(s: string): string {
  // Sequential in-place rewrites of the local markdown string. Reassigning the
  // param is intentional and behavior-equivalent to threading a local copy.
  ...
  // biome-ignore lint/style/noParameterAssign: sequential in-place rewrite of the input string.
